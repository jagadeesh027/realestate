      ...
      {property && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 sm:p-6">
          ...
          >
            <button
              onClick={onClose}
              className="absolute top-4 right-4 z-10 p-2 bg-white/90 backdrop-blur-sm rounded-full shadow-md hover:bg-accent hover:text-white transition-all"
            >
              <X className="w-6 h-6" />
            </button>
            ...
            <div className="md:w-1/2 h-64 md:h-auto relative">
              ...
              <div className="absolute bottom-6 left-6">
                <span className="px-4 py-1.5 bg-accent text-white text-xs font-bold tracking-widest uppercase rounded-full shadow-lg">
                  {property.type}
                </span>
              </div>
            </div>
            ...
            <div className="md:w-1/2 p-8 md:p-12 overflow-y-auto no-scrollbar">
              <div className="mb-8">
                <div className="flex items-center text-accent font-medium text-sm mb-2 tracking-widest uppercase">
                ...
                <div className="grid grid-cols-2 gap-y-3">
                  {property.amenities.map((amenity, i) => (
                    <div key={i} className="flex items-center text-sm text-gray-600">
                      <div className="w-5 h-5 rounded-full bg-accent/10 flex items-center justify-center mr-3">
